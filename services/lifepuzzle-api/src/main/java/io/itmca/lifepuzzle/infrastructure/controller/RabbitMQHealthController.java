            ...
            if (connectionFactory != null) {
                ...
                try {
                    ...
                    healthInfo.put("connectionDetails", Map.of(
                        "localAddress", connection.getLocalAddress() != null ? connection.getLocalAddress().toString() : "N/A",
                        "remoteAddress", connection.getAddress() != null ? connection.getAddress().toString() : "N/A",
